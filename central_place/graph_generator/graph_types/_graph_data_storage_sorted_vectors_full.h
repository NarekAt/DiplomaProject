...
/**
 * @file graph_types/_graph_data_storage_sorted_vectors_full.h
 * @brief Declaration of graph_data_storage_sorted_vectors_full class
 */
...
/**
 * @class graph_data_storage_sorted_vectors_full
 * @brief storage of data with full connection list,
 *        neighbour vertices are stored into sorted vector.
 */
class graph_data_storage_sorted_vectors_full : public graph_data_storage_base
{
...
public:
     ...
     */
    graph_data_storage_sorted_vectors_full(const graph_size& s);

    /**
     * @brief Copy-Constructor.
     * @param other storage to copy.
     */
    graph_data_storage_sorted_vectors_full(
     ...
     */
    graph_data_storage_sorted_vectors_full& operator=(
        const graph_data_storage_sorted_vectors_full& other);
    /// @}
