...
/**
 * @file graph_types/_graph_data_storage_sorted_vectors_partial.h
 * @brief Declaration of graph_data_storage_sorted_vectors_partial class
 */
...
/**
 * @class graph_data_storage_sorted_vectors_partial
 * @brief storage of data with partial connection list,
 *        neighbour vertices are stored into sorted vector.
 */
class graph_data_storage_sorted_vectors_partial : public graph_data_storage_base
{
...
public:
     ...
     */
    graph_data_storage_sorted_vectors_partial(const graph_size& s);

    /**
     * @brief Copy-Constructor.
     * @param other storage to copy.
     */
    graph_data_storage_sorted_vectors_partial(
     ...
     */
    graph_data_storage_sorted_vectors_partial& operator=(
        const graph_data_storage_sorted_vectors_partial& other);
    /// @}
...
public:
     ...
     */
    typedef std::vector<std::vector<vertex>> storage_type;
