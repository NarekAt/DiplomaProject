...
typedef ShortestPath::PathLengthProp PathLengthProp;
...
void calulate(const graph_types::graph& g,
              ...
              ShortestPath::DistanceResultCollection& pathLengths)
{
...
void
ShortestPath::calculate(const graph_types::graph& g, const VertexCollection& terminalVertices, PathLengthProp& pathLengths)
{
...
void
ShortestPath::calculate(const graph_types::graph& g, const VertexCollection& terminalVertices, DistanceResultCollection& pathLengths)
{
    calulate<BFSParams>(g, terminalVertices, pathLengths);
}

void
ShortestPath::calculate(const graph_types::graph& g, const WeightedVertexCollection& terminalVertices, DistanceResultCollection& pathLengths)
{
